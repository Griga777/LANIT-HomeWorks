...
public class Aviary<T extends Animal> {
    ...
    public void addAnimalInAviary(T animal) {
    ...
    public T getLinkOnAnimalInAviary(String nameAnimal) {
        if (!mapAnimals.containsKey(nameAnimal)) {
            throw new IllegalArgumentException("Такого животного с именем " + nameAnimal + " в вольере нет");
        }
